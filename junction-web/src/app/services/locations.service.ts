...
export class LocationsService {
  ...
  private mapAddJunctionResponse(
    response: AddJunctionResponse,
    ...
    const latitude = response.latitude ?? localityCoords.latitude;
    const longitude = response.longitude ?? localityCoords.longitude;
